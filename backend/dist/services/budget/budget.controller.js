...
class BudgetController {
    ...
    async createBudget(req, res) {
        try {
            ...
            const result = await (0, db_js_1.query)(`INSERT INTO budgets (user_id, category_id, amount_limit, period, start_date, end_date, alert_threshold)
         VALUES ($1, $2, $3, $4, $5, $6, $7)
         RETURNING id`, [userId, categoryId, limit, period, startDate, endDate, alertThreshold]);
