...
exports.classifyBill = classifyBill;
exports.getBillTypeLabel = getBillTypeLabel;
 ...
 */
function classifyBill(text, merchantName) {
    const scores = {
        receipt: 0,
        invoice: 0,
        utility: 0,
 ...
 */
function getSuggestedCategory(type) {
    const categoryMap = {
        receipt: null,
        invoice: null,
        utility: 'utilities',
...
//# sourceMappingURL=bill-classifier.js.map