...
reportRouter.get('/charts/category', controller.getCategoryChart);
reportRouter.get('/charts/trends', controller.getTrendsChart);
reportRouter.get('/charts/budget', controller.getBudgetChart);
